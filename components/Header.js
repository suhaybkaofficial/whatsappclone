...
function Header() {
  ...
  const {signOut} = useContext(FirebaseAuthContext)
  ...
  return (
    <div className="flex items-center  ">
        ...
        {/* Left Header*/}
      <div className="flex items-center justify-between min-h-[70px] bg-primaryColor  flex-[1_1_0%] px-4 relative" 
      onClick={showMore}
      >
      <div className="h-10 w-10 rounded-full cursor-pointer">
        ...
        {show && (
                <div className="absolute right-0 mt-28
